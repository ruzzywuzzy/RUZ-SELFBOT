...
async def suggest(ctx,*,message="Supply something to suggest lol!"):
    ...
    try:
        embed=discord.Embed(title=f"Ruz Selfbot - poll", description=f"Poll message : `{message}`", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="https://media.discordapp.net/attachments/817493346154446848/824284607745753119/image0.gif")
...
async def ip(ctx, *, iparg="1.1.1.1"):
    ...
    if personalip in desc:
        ...
        embed=discord.Embed(title=f"Ruz Selfbot - ip locator", description="Your ip was detected in this data - to double check that your ok with showing the data\npress the reaction button below!", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="https://media.discordapp.net/attachments/817493346154446848/824284607745753119/image0.gif")
        ...
        while reactionstuffyes:
            try:
                ...
                embed=discord.Embed(title=f"Ruz Selfbot - ip locator", description=desc, color=randcolor)
                embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                embed.set_footer(text="hi lol -Ruz")
                ...
                embed=discord.Embed(title=f"Ruz Selfbot - Ip locator", description="You took too long to react - try running this command again or sum", color=randcolor)
                embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                embed.set_footer(text="the ip locator?!??!!!")
                await message.edit(embed=embed)
            ...
            embed=discord.Embed(title=f"Ruz Selfbot - Ip locator", description=desc, color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="i def didnt steal this from someone..")
...
async def tokeninfo(ctx, bokenxd):
    ...
    # user info
        ...
        if nitroyems:
            ...
            embed=discord.Embed(title=f"Ruz Selfbot - Token info", description=f"Token info:\nUser : `{name}`\nUser-id : `{userid}`\nAvatar url : `{avatar}`\nPhone number linked : `{phone}`\nEmail verification status : `{isverified}`\nEmail linked : `{email}`\n2f/a Status : `{twofa}`\nFlags : `{flags}`\n\nNitro Data:\nHad nitro since : `{end}`\nNitro ends on : `{start}`\nTotal nitro : `{totalnitro}`", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="im bored plz help")
            await message.edit(embed=embed)
    else:
        embed=discord.Embed(title=f"Ruz Selfbot - Token info", description=f"Site responded with status code : `{data.status_code}`\nMessage : `{data.text}`", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="boop boop beep")
        await ctx.send(embed=embed)
...
async def ping(ctx,afkstatus=None):
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title=f"Ruz selfbot - ping pong ping pong ping pong ping pong ping pong ping pong ping pong ping pong ping pong ping pong", description=f'🏓 pong | {round(scalic.latency * 1000)}ms', color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="eoeoeo")
    await ctx.send(embed=embed)
...
"""   
    ...
    embed=discord.Embed(title=f"Ruz Selfbot", description=description, color=0x36393f)
    await ctx.send(embed=embed)
...
async def afk(ctx,afkstatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Afk auto messager", description=f"Afk messages are now : `{isafk}`\nTry {prefix.strip()}afkmessage [message]", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="run em 1's nigga mic up")
    await ctx.message.edit(content="",embed=embed)
...
async def afkmsg(ctx,*,afkstatus="I'm afk , wait for me to reply"):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Afk auto messager", description=f"Afk messages are : `{isafk}`\nAfk message is : `{messagetosendwhenafk}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="dun dun dun dun")
    await ctx.message.edit(content="",embed=embed)
...
async def uptime(ctx):
    ...
    seconds = timedata - 60*minutes
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Uptime", description=f"Ruzbot has been running for `{'%d:%d:%d' %(hours,minutes,seconds)}`", color=randcolor)
    embed.set_thumbnail(url="https://media.giphy.com/media/YpGPs0rAJQC1lngD0R/giphy.gif")
    embed.set_footer(text="https://github.com/scalic/scalic-selfbot")
    await ctx.message.edit(content="",embed=embed)
...
async def gamecycle(ctx):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Game Cycle", description=f"Cycling these statuses:\n`{statusdata}`\nDelay:\n`{delaybetweencycle}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="yuh yuh yuh")
    await ctx.message.edit(content="",embed=embed)
    while True:
...
async def biocycle(ctx):
    ...
    global delaybetweencycle
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Bio Cycle", description=f"Cycling these statuses:\n`{statusdata}`\nDelay:\n`{delaybetweencycle}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="we luv u tecca")
    await ctx.message.edit(content="",embed=embed)
...
async def watchcycle(ctx):
    ...
    global delaybetweencycle
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Watch Cycle", description=f"Cycling these statuses:\n`{statusdata}`\nDelay:\n`{delaybetweencycle}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="stop calling me ruzzy wuzzy fucker")
    await ctx.message.edit(content="",embed=embed)
    while True:
...
async def nicknamecycle(ctx,statustocycle=None):
    ...
    if statustocycle == None or statustocycle.lower() == "yes" or statustocycle.lower() == "on":
        ...
        embed=discord.Embed(title="Ruz Selfbot - Nickname Cycle", description=f"Cycle status : `{nicknamestuffyes}`\n{prefix.strip()}nicknamecycle **to start the cycle**", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="faygo u gettin bigga")
        await ctx.message.edit(content="",embed=embed)
...
async def nicknamecycledelay(ctx,newdelay="5"):
    ...
    embed=discord.Embed(title="Ruz Selfbot - Nickname Delay", description=f"Delay is now : `{delaybetweennicknamecycle} seconds`\n{prefix.strip()}nicknamecycle", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="i know shottie was a thottie")
    await ctx.message.edit(content="",embed=embed)
...
async def cycledelay(ctx,newdelay="5"):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Cycle Delay", description=f"Delay is now : `{delaybetweencycle} seconds", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="im bored tbh")
    await ctx.message.edit(content="",embed=embed)
...
async def listencycle(ctx):
    ...
    global delaybetweencycle
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Listen Cycle", description=f"Cycling these statuses:\n`{statusdata}`\nDelay:\n`{delaybetweencycle}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="Ruz Selfbot is cool")
    await ctx.message.edit(content="",embed=embed)
    while True:
...
async def streamcycle(ctx):
    ...
    global streamurl
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Stream Cycle", description=f"Cycling these statuses:\n`{statusdata}`\nDelay:\n`{delaybetweencycle}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="send nudes tyvm")
    await ctx.message.edit(content="",embed=embed)
    while True:
...
async def listen(ctx, *, listenstatus="I didn't know how to specify a listen status lol"):
    randcolor = random.randint(0x000000, 0xFFFFFF)
    await scalic.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name=listenstatus))
    embed=discord.Embed(title="Ruz Selfbot - Listen Status", description=f"Status is now : `Listening to {listenstatus}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="pew pew pew")
    await ctx.message.edit(content="",embed=embed)
...
async def game(ctx, *, gamestatus="I didn't know how to specify a game status lol"):
    ...
    embed=discord.Embed(title="Ruz Selfbot - Game Status", description=f"Status is now : `Playing {gamestatus}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="im so bored pls pls pls help")
    await ctx.message.edit(content="",embed=embed)
...
async def watch(ctx, *, watchstatus ="I didn't know how to specify a watch status lol"):
    randcolor = random.randint(0x000000, 0xFFFFFF)
    await scalic.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=watchstatus))    
    embed=discord.Embed(title="Ruz Selfbot - Watch Status", description=f"Status is now : `Watching {watchstatus}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="ladidadidadi -sofaygo")
    await ctx.message.edit(content="",embed=embed)
...
async def stream(ctx, *, streamstatus): 
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    await scalic.change_presence(activity=stream)  
    embed=discord.Embed(title="Ruz Selfbot - Stream Status", description=f"Status is now : `Streaming {streamstatus}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="bop bop bop")
    await ctx.message.edit(content="",embed=embed)
...
async def twitchurl(ctx, streamurltouse): 
    ...
    embed=discord.Embed(title="Ruz Selfbot - Stream Url Changed", description=f"Streamurl is now : `{streamurl}`\nTry {prefix.strip()}stream or {prefix.strip()}streamcycle", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="oui oui oui")
    await ctx.message.edit(content="",embed=embed)
...
async def bitcoin(ctx):
    ...
    dolor = j['USD']
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Bitcoin command", description=f"Bitcoin value : `${dolor}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="doot doot")
    await ctx.message.edit(content="",embed=embed)
...
async def invite(ctx): 
    ...
    embed=discord.Embed(title="Ruz Selfbot -Invite Creation", description=f"Invite Made - https://discord.gg/{str(inv.json()['code'])}", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="nd every night yo valentine ._.")
    await ctx.message.edit(content="",embed=embed)
...
async def timetodeleteafter(ctx,deletetime):
    ...
    embed=discord.Embed(title="Ruz Selfbot - Delete after time Edited", description=f"Delete after time is now : `{deletetime} seconds`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="staminaK tbh")
    await ctx.message.edit(content="",embed=embed)
...
async def deletemessagesafter(ctx,delstatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="Ruz Selfbot - Delete after", description=f"Deleting messages after they've been sent : `{deleteafter}`\nTime between them being sent and deletion : `{deleteaftertime}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="DUN DUN DUN")
    await ctx.message.edit(content="",embed=embed)
...
def ssspam(webhook):
    ...
    while spammingdawebhookeroos:
        ...
        data = {
          ...
          "embeds": [
            {
              ...
              "fields": [
                {
                  "name": "RUZ Nuker",
                  "value": "RUZ Nuker RUZ Nuker RUZ Nuker RUZ Nuker RUZ Nuker RUZ Nuker RUZ Nuker RUZ Nuker"
                },
                {
                  "name": "Nuked by RUZ Nuked by RUZ",
                  "value": "RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER RUZ NUKER "
                },
                {
                  "name": "RUZ Nuker RUZ Nuker RUZ Nuker",
              ...
              "author": {
                "name": "RUZ",
                "url": "youtube.com",
                "icon_url": "https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif"
              },
              "footer": {
                "text": " RUZ NUKE RUZ NUKE RUZ NUKE RUZ NUKE RUZ NUKE",
                "icon_url": "https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif"
              },
              "image": {
              ...
              "thumbnail": {
                "url": "https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif"
              }
            },
            {
          ...
          "username": "RUZ nuker RUZ nuker - an advanced selfbot made open source on github! @@@@",
          "avatar_url": "https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif"
        }
...
async def emotenuke(ctx):
    await ctx.message.delete()
    with open("https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif", "rb") as f:
        img1 = f.read()
    with open("https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif", "rb") as f:
        img2 = f.read()
    with open("https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif", "rb") as f:
...
async def hypesquad(ctx,squad=None):
    ...
    if squad == None:
        ...
        if data.status_code == 204:
            embed=discord.Embed(title="RUZ Selfbot - Hypesquad Changer", description=f"Hypesquad changed successfully", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="whatchu up 2")
            await ctx.message.edit(content="",embed=embed)
        else:
            embed=discord.Embed(title="RUZ Selfbot - Hypesquad Changer", description=f"Error - Site responded with status code : `{data.status_code}`\nMessage : `{data.text}`", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="son son son ice ice ice mono mono mono")
            await ctx.message.edit(content="",embed=embed)
...
async def impersonate(ctx, member: discord.Member=None,*,message="I forgot to supply a message"):
    ...
    if ctx.guild == None:
        ...
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="where my baby go i goooooo")
        await ctx.send(embed=embed)
    else:
        if not member:  
        ...
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="get packed son")
        await ctx.message.delete()
       ...
       # msg = await ctx.message.edit(content="",embed=embed)
        ...
        if req.status_code == 204:
            ...
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="bubububububbu")
            #await ctx.message.edit(content="",embed=embed,delete_after=2)            
        else:
            embed=discord.Embed(title=f"Impersonating {member.name}", description=f"\nWith message: \"{message}\"\n\nError Completing Task", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="this is so hard wtf")
            #await ctx.message.edit(content="",embed=embed)            

def makeguildxd(tokentouse,nukemsg):
    global serversmade

    # with open("https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif", "rb") as img:
...
async def fucktoken(ctx,tokentofrick=None,*,nukemsg=f"This account was nuked with the help of RUZ! - GG"):
    global serversmade
    serversmade = 0
    randcolor = random.randint(0x000000, 0xFFFFFF)
    await ctx.message.delete()
    if tokentofrick == None:
        embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Supply a token - {prefix.strip()}tokenfuck [token-here] [message-to-nuke-with]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="doo doo doo")
        await ctx.message.edit(content="",embed=embed)


    elif ctx.guild == None:
        embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Try do this command in a private server - it has problems in dms!", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="plz i ned egril")
        await ctx.message.edit(content="",embed=embed)

    else:
        embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"If your sure you want to token fuck the account, react with the emoji below.\nThis process will dm all open dms , then close them, leave all servers, and make a ton of servers", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="BRAH")
        message = await ctx.send(embed=embed)        
        await message.add_reaction('✅')
        randcolor = random.randint(0x000000, 0xFFFFFF)
        reactionstuffyes = True
        ...
        while reactionstuffyes:
            try:
                reaction, user = await scalic.wait_for('reaction_remove', timeout=10, check=requirements)
                embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"You reacted, the process has started!\nValidating token...", color=randcolor)
                embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                embed.set_footer(text="im cumming LOOL")
                await message.edit(embed=embed)
                await message.clear_reactions()
                reactionstuffyes = False
                ...
                if tokendata.status_code != 200:
                    embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Error - are you sure that token is correct?\nDiscord responded with : `{tokendata.text}`", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="what do i put here")
                    await message.edit(embed=embed)           
                else:
                    embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Token valid - continuing the process", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="idek if this works")
                    await message.edit(embed=embed)      
                    ...
                    randcolor = random.randint(0x000000, 0xFFFFFF)
                    embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Messaged {usersmessaged} people saying : `{nukemsg}` and cleared the conversation after", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="im bored again and still am rn help")
                    await message.edit(embed=embed)              
                    ...
                    randcolor = random.randint(0x000000, 0xFFFFFF)
                    embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Left `{serversleft}` servers", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="wtf is a scalic selfbot LOLZZ")
                    await message.edit(embed=embed)  
                    ...
                    randcolor = random.randint(0x000000, 0xFFFFFF)
                    embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Deleted `{serversdeleted}` servers", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="cuminnabun nigga")
                    try:
                        await message.edit(embed=embed)  
                    except:
                        pass
                    ...
                    randcolor = random.randint(0x000000, 0xFFFFFF)
                    embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"Made {serversmade} servers", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="send nudes")
                    try:
                        await message.edit(embed=embed)  
                    except:
                        pass
                ...
                embed=discord.Embed(title="RUZ Selfbot - Token Fuck", description=f"You took too long - Run this command again if you wish to token fuck an account", color=randcolor)
                embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                embed.set_footer(text="social reject music is good actually")
                await message.edit(embed=embed)
                await message.clear_reactions()
                reactionstuffyes= False
...
async def tokendisable(ctx,tokentofrick=None):
    ...
    await ctx.message.delete()
    if tokentofrick == None:
        embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"Supply a token - {prefix.strip()}tokendisable [token-here] ", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="ruz is shut a w name right guys?")
        await ctx.message.edit(content="",embed=embed)


    elif ctx.guild == None:
        embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"Try do this command in a private server - it has problems in dms (working on fixing)!", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="scalic selfbotK tbh")
        await ctx.message.edit(content="",embed=embed)

    else:
        embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"If your sure you want to disable that token, react.\nDisabling means that the account will be DISABLED - the chances of recovering it are pratically impossible.", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="help im lost")
        message = await ctx.send(embed=embed)        
        await message.add_reaction('✅')
        randcolor = random.randint(0x000000, 0xFFFFFF)
        reactionstuffyes = True
        ...
        while reactionstuffyes:
            try:
                reaction, user = await scalic.wait_for('reaction_remove', timeout=10, check=requirements)
                embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"You reacted, the process has started!\nDisabling token", color=randcolor)
                embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                embed.set_footer(text="everywhere i go they all know my name sosa can u hang ")
                await message.edit(embed=embed)
                await message.clear_reactions()
                reactionstuffyes = False
                ...
                randcolor = random.randint(0x000000, 0xFFFFFF)
                if tokendata.status_code != 200:
                    embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"Token disabled - discord responds with : `{tokendata.text}`", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="im the real kayla G")
                    await message.edit(embed=embed)           
                else:
                    embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"Token valid - strange - try again maybe?", color=randcolor)
                    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                    embed.set_footer(text="IM SO FUCKING BORED PLZ HELP BRO")
                    await message.edit(embed=embed)      

            except asyncio.TimeoutError:
                embed=discord.Embed(title="RUZ Selfbot - Token Disabler", description=f"You took too long - Run this command again if you wish to DISABLE an account", color=randcolor)
                embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                embed.set_footer(text="eepepepeeppeppepepep")
                await message.edit(embed=embed)
                await message.clear_reactions()
                reactionstuffyes= False
...
async def editsnipe(ctx):
    ...
    if str(ctx.channel.id) in editedmessages:
        ...
        embed=discord.Embed(title="RUZ Selfbot - Edit snipe", description=f"Message sniped:\n{msgsniped}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="might quit packing")
        await ctx.message.edit(content="",embed=embed)

    else:
        embed=discord.Embed(title="RUZ Selfbot - Edit snipe", description=f"No edited messages to snipe", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="am i cool for making a selfbot now")
        await ctx.message.edit(content="",embed=embed)
...
async def unban(ctx, userid="Nonexd"):
    ...
    if len(str(userid)) != 18:
        embed=discord.Embed(title="RUZ Selfbot - Unban Command", description=f"\nCommand usage : {prefix.strip()}unban [id]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="pls someone dm me")
        await ctx.message.edit(content="",embed=embed)   
    else:
        ...
        try:
            ...
            embed.set_thumbnail(url="https://media.giphy.com/media/YpGPs0rAJQC1lngD0R/giphy.gif")
            embed.set_footer(text="cyrusK fake ubbers owner")
            await ctx.message.edit(content="",embed=embed)   
            
        except Exception as errorunbanning:
            embed=discord.Embed(title="RUZ Selfbot - Unban Command", description=f"\nError Unbanning {userid}\n{errorunbanning}", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="where is my homie orbit :/")
            await ctx.message.edit(content="",embed=embed) 
...
async def banid(ctx, userid="Nonexd",reason="None specified"):
    randcolor = random.randint(0x000000, 0xFFFFFF)
    if len(str(userid)) != 18:
        embed=discord.Embed(title="RUZ Selfbot - Ban ID Command", description=f"\nCommand usage : {prefix.strip()}banid [id]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="nunununun")
        await ctx.message.edit(content="",embed=embed)   
    else:
        ...
        try:
            ...
            embed=discord.Embed(title="RUZ Selfbot - Ban Command", description=f"\nBanned {userid}", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="wanna listen 2 spotify w me<3")
            await ctx.message.edit(content="",embed=embed)   
            
        except Exception as errorbanning:
            embed=discord.Embed(title="RUZ Selfbot - Ban Command", description=f"\nError Banning {userid}\n{errorbanning}", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="ding dong ding dong")
            await ctx.message.edit(content="",embed=embed) 
...
async def kick(ctx, member : discord.Member,reason="None specified"):
    ...
    if member.id == ctx.author.id:
        embed=discord.Embed(title="RUZ Selfbot - Kick Command", description=f"\nTry {prefix.strip()}leave [server-id] instead!", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="github is cool")
        await ctx.message.edit(content="",embed=embed) 
    else:
...
async def ban(ctx, member : discord.Member,reason="None specified"):
    ...
    if member.id == ctx.author.id:
        ...
        try:
            ...
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="son son son")
            await ctx.message.edit(content="",embed=embed) 
        except Exception as errorbanning:
            embed=discord.Embed(title="RUZ Selfbot - Ban Command", description=f"\nError Banning {member.mention}\n{errorbanning}", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="no motivationnn")
            await ctx.message.edit(content="",embed=embed) 
mimicstatus = "off"
@scalic.command()
async def mimic(ctx, member : discord.Member=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    if member == None:
        embed=discord.Embed(title="RUZ Selfbot - Mimic Command", description=f"\nTry {prefix.strip()}mimic [member]\nor type {prefix.strip()}mimic off", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="tenz tenz tenz")
        await ctx.message.edit(content="",embed=embed)
...
async def downloadguildemojis(ctx, guildid=None):
    if guildid == None:
        ...
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title=f"RUZ Selfbot - Emoji stealing from {guildtostealfrom.name}", description=f"Details:\nSuccessful emoji steals : {emojisuccess}\nErrors with emoji steals : {emojierror}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="cum inside my mouth yuh")
        await ctx.message.edit(content="",embed=embed)
...
async def stealguildemoji(ctx, guildid=None):
    if guildid == None:
        ...
        embed=discord.Embed(title=f"RUZ Selfbot - Emoji stealing from {guildtostealfrom.name}", description=f"Details:\nSuccessful emoji steals : {emojisuccess}\nErrors with emoji steals : {emojierror}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="i luv eden")
        await ctx.message.edit(content="",embed=embed)
        ...
        for emoji in guildtostealfrom.emojis:
            ...
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="hopefully me nd eden are still together by the time this ends")
            await ctx.message.edit(embed=embed)
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title=f"RUZ Selfbot - Finished emoji stealing from {guildtostealfrom.name}", description=f"Details:\nSuccessful emoji steals : {emojisuccess}\nErrors with emoji steals : {emojierror}\n{emojilist}", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="stimulate ur senses")
    await ctx.message.edit(embed=embed)
...
async def embedspam(ctx, count=5, *, desc="I forgot to specify the embed content"):
    ...
    if int(count) > 25:
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - embed spam", description=f"{count} embeds is too much - do 25 or less", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="she wanna blow me up yeh")
        await ctx.send(embed=embed)
    else:
        for i in range(int(count)):
            randcolor = random.randint(0x000000, 0xFFFFFF)
            embed=discord.Embed(title="RUZ Selfbot - embed spam", description=desc, color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="run")
            await ctx.send(embed=embed)
...
async def spam(ctx, count=5, *, desc="I forgot to specify the content to spam"):
    ...
    if int(count) > 25:
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - spam", description=f"{count} messages is too much - do 25 or less", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="charger beep beep")
        await ctx.send(embed=embed)
    else:
        for i in range(int(count)):
            await ctx.send(desc)
...
async def spampin(ctx, count=None):
    if count == None:
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - Pin spam", description=f"You didn't specify the amount of pins to do.\n{prefix.strip()}spampin [amount]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="bitch bitch bitch")
...
async def logout(ctx):
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Logging out", description=f"Logging out!", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="ruz owns me")
    await ctx.message.edit(content="",embed=embed)
    await scalic.logout()
...
#    randcolor = random.randint(0x000000, 0xFFFFFF)
#    embed=discord.Embed(title="RUZ Selfbot - Restarting", description=f"Restarting!", color=randcolor)
#    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
#    embed.set_footer(text="cuminnabun")
#    await ctx.message.edit(content="",embed=embed)
#    await scalic.logout()
...
async def clear(ctx, amount):
    ...
    await ctx.message.delete()
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Message purger", description=f"Deleting messages", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    ...
    async for message in ctx.message.channel.history(limit=int(amount)).filter(
        ...
        try:
            if message != msg:
                ...
                deleted = deleted + 1
                #embed=discord.Embed(title="RUZ Selfbot - Message purger", description=f"Deleted {deleted} messages", color=randcolor)
                #embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
                #embed.set_footer(text="shut up bitch")
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Message purger", description=f"Finished.\nDeleted {deleted} messages", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="stupid slut")
...
async def clearcontent(ctx, amount,*,messagetoclear):
    ...
    embed=discord.Embed(title="RUZ Selfbot - Message purger", description=f"Deleting messages", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="purgin nd purgin")
    await ctx.message.edit(content="",embed=embed)
    async for message in ctx.message.channel.history(limit=int(amount)).filter(
    ...
    embed=discord.Embed(title="RUZ Selfbot - Message purger", description=f"Finished.\nDeleted {deleted} messages", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="eooeoeoeooeooeoe")
...
async def spamreact(ctx, count=None, reaction=None):
    ...
    if count == None or reaction == None:
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - React spam", description=f"You didn't specify the amount of messages to react to or the reaction to use.\n{prefix.strip()}spamreact [amount]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="my pc is sloww")
...
async def spamedit(ctx, count=None,*, mesg=None):
    ...
    if count == None or mesg == None:
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - Message edit spam", description=f"You didn't specify the amount of messages to edit or the content to edit the messages to.\n{prefix.strip()}spamedit [amount] [message]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="broken")

        await ctx.send(embed=embed)
    else:
        edited = 0
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - Message edit spam", description=f"Editing messages", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="nnnnnnnnnnnn")
        msg= await ctx.send(embed=embed)
        ...
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - Message edit spam", description=f"Finished.\nEdited {edited} messages", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="yung chris is fire brah")
        await msg.edit(embed=embed,delete_after=3)
...
async def tokenhalf(ctx, member: discord.Member):#
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Message edit spam", description=f"{member.name}'s Token Begins With : \n`{final[1:]}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="prop gun pew")
    await ctx.message.edit(content="",embed=embed)
...
async def logdeletedmessages(ctx,deletestatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Deleted message logger", description=f"Deleted message logger is now : `{deletedmessagelogger}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="bang bang")
    await ctx.message.edit(content="",embed=embed)
...
async def logediteddmessages(ctx,editstatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Edited message logger", description=f"Edited message logger is now : `{editedmessagelogger}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="pop")
    await ctx.message.edit(content="",embed=embed)
...
async def edit(ctx,editstatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Edit mode", description=f"Edit mode is now : `{statusofediting}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="gay man ")
    await ctx.message.edit(content="",embed=embed)#
...
async def talkcute(ctx,talkcuteyems=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Cute talk", description=f"Edit mode is now : `{talkingcuteyems}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="dowajdowijodwijaoiwdw")
    await ctx.message.edit(content="",embed=embed)
...
async def nitrosnipe(ctx,snipestatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Nitro Sniper", description=f"Nitro sniper is now : `{nitrosniping}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="im boreddddd")
    await ctx.message.edit(content="",embed=embed)
...
async def privnotesnipe(ctx,snipestatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Privnote Sniper", description=f"Privnote sniper is now : `{privnotesniping}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="scuhhhh")
    await ctx.message.edit(content="",embed=embed)
...
async def notifications(ctx,notifstatushm=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Notifications", description=f"Notifications are now : `{notifsyems}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="yes yes yes yes")
    await ctx.message.edit(content="",embed=embed)
...
async def giveawaysnipe(ctx,snipestatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Giveaway Sniper", description=f"Giveaway sniper is now : `{giveawaysniping}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="beepepeppepep")
    await ctx.message.edit(content="",embed=embed)
...
async def backup(ctx,snipestatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Backup", description=f"Backing up friends...", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="noononononono")
    await ctx.message.edit(content="",embed=embed)
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Backup", description=f"Saved `{friendssaved}` friends", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="SCARY")
    await ctx.message.edit(content="",embed=embed)
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Backup", description=f"Saved `{friendssaved}` friends and `{serverssaved}` servers", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="selfbot go brrr")
    await ctx.message.edit(content="",embed=embed)
    ...
    f.close()
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Backup", description=f"Saved `{friendssaved}` friends , `{serverssaved}` servers and `{groupssaved}` group chats.", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="BRHAHHRAHRAHR")
    await ctx.message.edit(content="",embed=embed)
...
async def pastebinsnipe(ctx,snipestatus=None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Pastebin Sniper", description=f"Pastebin sniper is now : `{pastebinsniping}`", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="RUZZZZZZ")
    await ctx.message.edit(content="",embed=embed)
...
async def idtoname(ctx, personsid: int):
    if len(str(personsid)) != 18:
        ...
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - Id to username", description=f"ID [{str(personsid)}]  = `{user.name}#{user.discriminator}`", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
...
async def hastebin(ctx, *,paste=f"Format is {prefix.strip()}hastebin [text]"):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Hastebin Command", description=f"Here's your paste!\n{textlink}{endoflink}", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="im not mean")
    await ctx.message.edit(content="",embed=embed)
...
async def nuke(ctx):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Channel Nuked", description=f"<#{new_chan.id}> - {new_chan.name} has been nuked", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="they are true?")
...
async def tinyurl(ctx,link=None):
    ...
    await ctx.message.delete()
    if link == None:
        embed=discord.Embed(title=f"RUZ Selfbot - Url shortener", description=f"You didn't supply a link - {prefix.strip()}tinyurl [link-here]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="noooooooooooooo")
        message = await ctx.send(embed=embed)
    else:
        embed=discord.Embed(title=f"RUZ Selfbot - Shortening link", description=f"beep bop beep", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="i hate gay people")
        message = await ctx.send(embed=embed)

        randcolor = random.randint(0x000000, 0xFFFFFF)
        shortened = requests.get(f"https://tinyurl.com/api-create.php?url={link}").text
        embed=discord.Embed(title=f"RUZ Selfbot - Url shortener", description=f"Link shortened : \n{shortened}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="boop")
        message = await ctx.send(embed=embed)
...
async def join(ctx,link=None):#
    await ctx.message.delete()
    if link == None:
        embed=discord.Embed(title=f"RUZ Selfbot - Server joiner", description=f"You didn't supply an invite - {prefix.strip()}join discord.gg/server", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="BRUHHH")
        await ctx.send(embed=embed)
    else:
        headers = {'Authorization': token.strip(), 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36', 'Accept': '*/*',}
        ...
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title=f"RUZ Selfbot - Server joiner", description=f"Joining server : `discord.gg/{link}`", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="BRUHHHH")
        message = await ctx.send(embed=embed)
        ...
        if joint == 200:
            ...
            embed=discord.Embed(title=f"RUZ Selfbot - Server joiner", description=f"Successfully joined : `discord.gg/{link}`", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="i believe u sure")
            

        else:
            embed=discord.Embed(title=f"RUZ Selfbot - Server joiner", description=f"Error Joining : `discord.gg/{link}`", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="youtube is cool")
        await message.edit(embed=embed)
...
async def leave(ctx,servid=None):#
    ...
    if servid == None:
        ...
        embed=discord.Embed(title=f"RUZ Selfbot - Server Leaver", description=f"Leaving `{servid}`", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="reedoW?")
        message = await ctx.send(embed=embed)
        leave = requests.delete(f"https://discord.com/api/v8/users/@me/guilds/{servid}", headers=headers)
        randcolor = random.randint(0x000000, 0xFFFFFF)
        if leave.status_code == 204:
        
            embed=discord.Embed(title=f"RUZ Selfbot - Server Leaver", description=f"Success | Left Server : `{servid}`", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="vroom vroom")
            await message.edit(embed=embed)
...
async def serverinfo(ctx):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title=f"RUZ Selfbot - Gathering info on {ctx.guild.name}", description="...", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="vroooooom")
    message = await ctx.send(embed=embed)
    await asyncio.sleep(1)
    try:
...
"""
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title=f"RUZ Selfbot - {ctx.guild.name}", description=info, color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
...
async def userinfo(ctx, member: discord.Member = None):
    ...
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - User info", description=f"Getting user info on {member.name}", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="LOLOLOLLOOOLOLLOLOLO")
    message = await ctx.send(embed=embed)
    await asyncio.sleep(2)
...
"""  
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title=f"RUZ Selfbot - {member.name}#{member.discriminator}", description=info, color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="clueless")
    await message.edit(embed=embed)
...
async def dmclear(ctx):
    ...
    await ctx.message.delete()
    randcolor = random.randint(0x000000, 0xFFFFFF)
    embed=discord.Embed(title="RUZ Selfbot - Message Clearer", description=f"Clearing all messages with all users", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="never seen 2 pretty best friends")
    msg= await ctx.send(embed=embed)
    for channel in scalic.private_channels:
        ...
        randcolor = random.randint(0x000000, 0xFFFFFF)
        embed=discord.Embed(title="RUZ Selfbot - Message Clearer", description=f"Clearing all messages with all users\nUsers Done : {usersdone}\nTotal Messages Deleted : {totalmessage}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="Vyacide on roblox")
...
async def joke(ctx):
    ...
    embed=discord.Embed(title="RUZ Selfbot - Joke requested", description=f"{setup}\n||{delivery}||", color=randcolor)
    embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
    embed.set_footer(text="british accents are hot")
    await ctx.message.edit(content="",embed=embed)
...
async def ud(ctx,*,wordtodefine=None):
    ...
    if wordtodefine == None:  
        embed=discord.Embed(title="RUZ Selfbot - Urban Dictionary Command", description=f"You didn't supply a word to define?", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="hhhhhhhhh")
        await ctx.message.edit(content="",embed=embed)
    else:
        ...
        try:
            ...
            embed=discord.Embed(title="RUZ Selfbot - Urban Dictionary Command", description=f"Definition of `{wordtodefine}`\n{finaldef}\n\n", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="im bored")
            await ctx.message.edit(content="",embed=embed)
        except:
            embed=discord.Embed(title="RUZ Selfbot - Urban Dictionary Command", description=f"Error when searching for the term : `{wordtodefine}`", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
...
async def name(ctx,*,namesupplied=None):
    ...
    if namesupplied == None:
        embed=discord.Embed(title="RUZ Selfbot - Gender command", description=f"You didn't supply a name\n{prefix.strip()}name [name]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="tired smh")
        await ctx.message.edit(content="",embed=embed)
    else:
        ...
        embed=discord.Embed(title="RUZ Selfbot - Gender command", description=f"Majority of people named {namesupplied} are {gen}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="huh")
        await ctx.message.edit(content="",embed=embed)
...
async def webhookdelete(ctx,link=None):
    randcolor = random.randint(0x000000, 0xFFFFFF)
    if link == None:
        embed=discord.Embed(title="RUZ Selfbot - No webhook supplied", description=f"{prefix.strip()}webhookdelete [webhook]", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="uglyyy")
        await ctx.message.edit(content="",embed=embed)
    else:
        embed=discord.Embed(title="RUZ Selfbot - Deleting webhook", description=f"Sending a delete request to\n{link}", color=randcolor)
        embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
        embed.set_footer(text="BRUHHHHHHHHH")
        await ctx.message.edit(content="",embed=embed)
        ...
        if result.status_code == 204:
            embed=discord.Embed(title="RUZ Selfbot - Webhook Deleted", description=f"Yay", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="cheatingK")
            await ctx.message.edit(embed=embed)
        else:
            embed=discord.Embed(title="RUZ Selfbot - Error Deleting Webhook", description=f"Delete request responded with status code : {result.status_code}\{result.text}", color=randcolor)
            embed.set_thumbnail(url="https://c.tenor.com/ZINgFAwKh1QAAAAM/anime-love.gif")
            embed.set_footer(text="I FINISHED OH MY GOD")
            await ctx.message.edit(embed=embed)
